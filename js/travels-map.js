(function () {
  ...
  const COUNTRIES = [
    { id: "050", code: "BD", name: "Bangladesh", lon: 90.41, lat: 23.81, href: "travels-bangladesh.html" },
    { id: "764", code: "TH", name: "Thailand", lon: 100.5, lat: 13.75, href: "travels-thailand.html" },
    { id: "784", code: "AE", name: "United Arab Emirates", lon: 54.37, lat: 24.45, href: "travels-uae.html" },
    { id: "458", code: "MY", name: "Malaysia", lon: 101.98, lat: 4.21, href: "travels-malaysia.html" },
  ];
  ...
  list.innerHTML = COUNTRIES.map(
    ...
    <a class="map-country-row" href="${c.href}" data-id="${c.id}">
      ...
      <span class="map-country-arrow" aria-hidden="true">→</span>
    </a>`
  ).join("");
